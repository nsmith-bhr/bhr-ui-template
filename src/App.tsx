...
import { Home, MyInfo, People, Hiring, Reports, Files, Payroll, Settings, Inbox, NewEmployeePage, DatePickerDemo, CreateJobOpening, JobAIPrototype, PhoneInputDemo } from './pages';
            ...
            element={
              <AppLayout>
                <Routes>
                  ...
                  <Route path="/phone-input-demo" element={<PhoneInputDemo />} />
                </Routes>
              </AppLayout>
            }
          />
