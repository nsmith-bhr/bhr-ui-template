...
export function Hiring() {
  ...
  return (
    <div className="p-10">
      ...
      {/* Tabs */}
      <div className="flex items-center justify-between mb-6 border-b border-[var(--border-neutral-x-weak)]">
        ...
        <div className="flex items-center gap-2 text-[14px] text-[var(--text-neutral-medium)] pb-3">
